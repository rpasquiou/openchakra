              ...
              <Grid container>
                <Grid item className={classes.containerLeft}>
                  ...
                  <Grid style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                    <Grid>
                      <Button onClick={() => this.payDirect()} type="submit" variant="contained"
                              className={classes.isSelected} disabled={this.state.cardSelected ? false : true}>
                        {this.state.cardSelected ? 'Payer en 1 clic' : 'Selectionner une carte'}
                      </Button>
                    </Grid>
                    <Grid>
                      <Button variant={'contained'} className={classes.paiementMethode} value={this.state.valueother}
                              onClick={() => this.pay()}>
