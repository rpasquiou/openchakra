...
class NavBar extends Component {
  ...
  render() {
    ...
    const becomealfred = <MenuItem onClick={this.handleMobileMenuClose}><Typography><Link href={'/creaShop/creaShop'}><a className={classes.navbarLinkMobile}>Proposer services</a></Link></Typography></MenuItem>;
    const mobileavatar =
      <React.Fragment>
