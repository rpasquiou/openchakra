...
const search = async ({ model, fields, search_field = SEARCH_FIELD_ATTRIBUTE, search_value, user, params = {} }) => {
  const loadFields = [...fields, search_field]
  const data = await loadFromDb({ model, fields: loadFields, user, params })
