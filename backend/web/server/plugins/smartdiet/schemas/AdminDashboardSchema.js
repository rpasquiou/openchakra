...
AdminDashboardSchema.virtual('users_men_percent', DUMMY_REF).get(function() { return 0 })
AdminDashboardSchema.virtual('users_women_percent', DUMMY_REF).get(function() { return 0 })
AdminDashboardSchema.virtual('users_no_gender_percent', DUMMY_REF).get(function() { return 0 })
