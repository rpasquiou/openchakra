...
AdminDashboardSchema.virtual(`incalls_per_operator_details`, DUMMY_REF).get(function() {return 0})
AdminDashboardSchema.virtual(`outcalls_per_operator_details`, DUMMY_REF).get(function() {return 0})
AdminDashboardSchema.virtual(`incalls_per_operator_total`, DUMMY_REF).get(function() {return 0})
AdminDashboardSchema.virtual(`outcalls_per_operator_total`, DUMMY_REF).get(function() {return 0})
