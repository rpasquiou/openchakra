...
declareVirtualField({ model: 'adminDashboard', field: 'users_men_percent', instance: 'Number' })
declareVirtualField({ model: 'adminDashboard', field: 'users_women_percent', instance: 'Number' })
declareVirtualField({ model: 'adminDashboard', field: 'users_no_gender_percent', instance: 'Number' })
