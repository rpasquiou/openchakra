...
const CALL_STATUS_CONVERTI_COA="CALL_STATUS_CONVERTI_COA"
const CALL_STATUS_CONVERTI_CN="CALL_STATUS_CONVERTI_CN"
const CALL_STATUS_CONVERTI_COA_CN="CALL_STATUS_CONVERTI_COA_CN"
const CALL_STATUS_WRONG_NUMBER="CALL_STATUS_WRONG_NUMBER"
...
const CALL_STATUS={
  ...
  [CALL_STATUS_CONVERTI_CN]:"CN réalisé",
  [CALL_STATUS_CONVERTI_COA_CN]:"CN réalisé & COA à venir",
...
const COACHING_CONVERSION_STATUS={
  [COACHING_CONVERSION_TO_COME]:"COA à venir",
  [COACHING_CONVERSION_CONVERTED]:"COA converti",
  [COACHING_CONVERSION_CANCELLED]:"COA annulé",
}
...
const SOURCE_SMARTAGENDA=`SOURCE_SMARTAGENDA`

const SOURCE={
  [SOURCE_CALL]:`CALL`,
  [SOURCE_APPLICATION]:`APPLICATION`,
  [SOURCE_SMARTAGENDA]:`SMARTAGENDA`,
}

const CONTENT_VISIBILITY_FOR_ALL='CONTENT_VISIBILITY_FOR_ALL'
const CONTENT_VISIBILITY_FOR_COMPANIES='CONTENT_VISIBILITY_FOR_COMPANIES'

const CONTENT_VISIBILITY={
  [CONTENT_VISIBILITY_FOR_ALL]:'Pour tous',
  [CONTENT_VISIBILITY_FOR_COMPANIES]:'Pour entreprises',
}

const CONTENT_ARTICLE_STAR='CONTENT_ARTICLE_STAR'
const CONTENT_ARTICLE_NO_STAR='CONTENT_ARTICLE_NO_STAR'

const CONTENT_ARTICLE={
  [CONTENT_ARTICLE_STAR]:'A la une',
  [CONTENT_ARTICLE_NO_STAR]:'Dans les articles seulement',
}

const ASSESSMENT_STATUS_VALIDATED = 'ASSESSMENT_STATUS_VALIDATED'
const ASSESSMENT_STATUS_IN_PROGRESS = 'ASSESSMENT_STATUS_IN_PROGRESS'

const ASSESSMENT_STATUS = {
  [ASSESSMENT_STATUS_VALIDATED]: 'Validé',
  [ASSESSMENT_STATUS_IN_PROGRESS]: 'En cours',
}
...
module.exports={
  ...
  SOURCE, SOURCE_APPLICATION, SOURCE_CALL, SOURCE_SMARTAGENDA,
  ...
  RESET_TOKEN_VALIDITY, ASSESSMENT_STATUS, ASSESSMENT_STATUS_VALIDATED, ASSESSMENT_STATUS_IN_PROGRESS,
}
