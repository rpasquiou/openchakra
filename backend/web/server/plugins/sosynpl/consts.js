...
const ANNOUNCE_STATUS={
  ...
  [ANNOUNCE_STATUS_CANCELED]:`Annulée`,
...
const APPLICATION_VISIBILITY = {
  [APPLICATION_VISIBILITY_HIDDEN]: `Masqué`,
  [APPLICATION_VISIBILITY_VISIBLE]: `Visible`,
}

const TARGET_CUSTOMER = `TARGET_CUSTOMER`
const TARGET_FREELANCE = `TARGET_FREELANCE`

const TARGET={
  [TARGET_CUSTOMER]: `Client`,
  [TARGET_FREELANCE]: `Indépendant`,
}
...
module.exports={
  SOSYNPL, ROLES, COMPANY_SIZE, WORK_DURATION, WORK_DURATION_LESS_1_MONTH, WORK_DURATION_MORE_6_MONTH, WORK_DURATION__1_TO_6_MONTHS, VALID_STATUS, VALID_STATUS_PENDING, SOURCE,
  ...
  CUSTOMER_REQUIRED_ATTRIBUTES, CUSTOMER_OUTPUT_ATTRIBUTES, REASON_OTHER, APPLICATION_VISIBILITY, APPLICATION_VISIBILITY_HIDDEN, APPLICATION_VISIBILITY_VISIBLE, MIN_EXPERTISES, MIN_PINNED_EXPERTISES, TARGET, TARGET_CUSTOMER, TARGET_FREELANCE
}
