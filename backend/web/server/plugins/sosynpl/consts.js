...
const ROLE_FREELANCE=`ROLE_FREELANCE`
...
const WORK_DURATION={
  [WORK_DURATION_LESS_1_MONTH]:`less_1_month`,
  [WORK_DURATION__1_TO_6_MONTHS]:`_1_TO_6_MONTHS`,
  [WORK_DURATION_MORE_6_MONTH]:`MORE_6_month`,
}
...
const SOURCE_RECOMNDATION=`SOURCE_RECOMNDATION`
...
const SOURCE={
  [SOURCE_RECOMNDATION]:`recomndation`,
  [SOURCE_SOSYNPL_CONTACT]:`sosynpl_contact`,
  [SOURCE_EVENT]:`event`,
  [SOURCE_SOCIAL_NETWORK]:`social_network`,
  [SOURCE_NEWS_BLOG]:`news_blog`,
  [SOURCE_OTHER]:`other`,
}
...
module.exports={
  SOSYNPL, ROLE, NATIONALITIES, COMPANY_SIZE, WORK_MODE, WORK_DURATION, VALID_STATUS, VALID_STATUS_PENDING, SOURCE,
  DISCRIMINATOR_KEY, DISC_CUSTOMER, DISC_FREELANCE, DISC_ADMIN, EXPERIENCE,
}
