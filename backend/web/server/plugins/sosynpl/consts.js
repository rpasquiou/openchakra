...
const SS_PILIER_CREATOR=`SS_PILIER_CREATOR`
const SS_PILIER_IMPLEMENTOR=`SS_PILIER_IMPLEMENTOR`
const SS_PILIER_OPTIMIZER=`SS_PILIER_OPTIMIZER`
const SS_PILIER_NETWORKER=`SS_PILIER_NETWORKER`
const SS_PILIER_COORDINATOR=`SS_PILIER_COORDINATOR`
const SS_PILIER_DIRECTOR=`SS_PILIER_DIRECTOR`

const SS_PILIER={
  [SS_PILIER_CREATOR]:`Créateur`,
  [SS_PILIER_IMPLEMENTOR]:`Implémenteur`,
  [SS_PILIER_OPTIMIZER]:`Optimisateur`,
  [SS_PILIER_NETWORKER]:`Réseauteur`,
  [SS_PILIER_COORDINATOR]:`Coordinateur`,
  [SS_PILIER_DIRECTOR]:`Directeur`,
}
...
const SS_THEMES_COMM=`SS_THEMES_COMM`
const SS_THEMES_TEAMWORK=`SS_THEMES_TEAMWORK`
const SS_THEMES_CONFLICT=`SS_THEMES_CONFLICT`
const SS_THEMES_CHANGE=`SS_THEMES_CHANGE`
const SS_THEMES_FEDERATE=`SS_THEMES_FEDERATE`
const SS_THEMES_CREATIVE=`SS_THEMES_CREATIVE`
const SS_THEMES_ADAPTATION=`SS_THEMES_ADAPTATION`
const SS_THEMES_ANALYSIS=`SS_THEMES_ANALYSIS`
const SS_THEMES_ORGANIZATION=`SS_THEMES_ORGANIZATION`
const SS_THEMES_MANAGE=`SS_THEMES_MANAGE`

const SS_THEMES={
  [SS_THEMES_COMM]:`Communication`,
  [SS_THEMES_TEAMWORK]:`Travail en équipe`,
  [SS_THEMES_CONFLICT]:`Gestion des conflits`,
  [SS_THEMES_CHANGE]:`Promoteur du changement`,
  [SS_THEMES_FEDERATE]:`Capacité à fédérer`,
  [SS_THEMES_CREATIVE]:`Créativité, curiosité`,
  [SS_THEMES_ADAPTATION]:`Adaptabilité`,
  [SS_THEMES_ANALYSIS]:`Analyse, prise de recul`,
  [SS_THEMES_ORGANIZATION]:`Organisation`,
  [SS_THEMES_MANAGE]:`Diriger, manager`,
}
...
module.exports={
  ...
  AVAILABILITY, AVAILABILITY_UNDEFINED, AVAILABILITY_UNDEFINED, AVAILABILITY_ON, AVAILABILITY_OFF, SS_PILIER,
  SS_PILIER_COORDINATOR, SS_PILIER_CREATOR, SS_PILIER_DIRECTOR, SS_PILIER_IMPLEMENTOR, SS_PILIER_NETWORKER, SS_PILIER_OPTIMIZER,
  SS_MEDALS, SS_MEDALS_GOLD, SS_MEDALS_SILVER, SS_MEDALS_BRONZE,
  SS_THEMES, SS_THEMES_COMM, SS_THEMES_TEAMWORK,SS_THEMES_CONFLICT,SS_THEMES_CHANGE,SS_THEMES_FEDERATE,SS_THEMES_CREATIVE,
  SS_THEMES_ADAPTATION, SS_THEMES_ANALYSIS, SS_THEMES_ORGANIZATION,SS_THEMES_MANAGE,
}
