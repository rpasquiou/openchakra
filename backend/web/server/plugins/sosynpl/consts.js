...
const ANNOUNCE_STATUS_ARCHIVED=`ANNOUNCE_STATUS_ARCHIVED`
...
const ANNOUNCE_STATUS={
  ...
  [ANNOUNCE_STATUS_ARCHIVED]:`Archivée`,
...
const QUOTATION_STATUS={
  ...
  [QUOTATION_STATUS_OUTDATED]:`outdated`,
  [QUOTATION_STATUS_ACCEPTED]:`accepted`,
  [QUOTATION_STATUS_REFUSED]:`refused`,
}

const SOSYNPL_LANGUAGES=require('./languages.json')

const FREELANCE_COMMISSION_RATE=0.5
...
module.exports={
  ...
  ANNOUNCE_MOBILITY, MOBILITY_NONE, COMMISSION, ANNOUNCE_STATUS, ANNOUNCE_STATUS_DRAFT, ANNOUNCE_STATUS_ACTIVE, ANNOUNCE_STATUS_PROVIDED, ANNOUNCE_STATUS_ARCHIVED,
  APPLICATION_STATUS, APPLICATION_STATUS_NONE, APPLICATION_STATUS_SENT, DURATION_UNIT_DAYS, SOSYNPL_LANGUAGES,
  ANNOUNCE_SUGGESTION, ANNOUNCE_SUGGESTION_SENT, ANNOUNCE_SUGGESTION_ACCEPTED, ANNOUNCE_SUGGESTION_REFUSED, REFUSE_REASON,
  FREELANCE_COMMISSION_RATE, CUSTOMER_COMMISSION_RATE, QUOTATION_STATUS, QUOTATION_STATUS_DRAFT,
}
