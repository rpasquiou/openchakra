...
const { NATIONALITIES, WORK_MODE, SOURCE, EXPERIENCE, ROLES, ROLE_CUSTOMER, ROLE_FREELANCE, WORK_DURATION, COMPANY_SIZE, DISC_ADMIN, DISC_CUSTOMER, DISC_FREELANCE, LEGAL_STATUS, DEACTIVATION_REASON, SUSPEND_REASON, SUSPEND_STATE } = require("./consts")
...
MODELS.forEach(model => {
  ...
  declareEnumField({model, field: 'suspended_status', enumValues: SUSPEND_STATE})
