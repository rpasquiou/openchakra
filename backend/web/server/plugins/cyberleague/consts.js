...
const OFFER_VISIBILITY = {
  [OFFER_VISIBILITY_PRIVATE]: `prive`,
  [OFFER_VISIBILITY_PUBLIC]: `public`
}
...
module.exports = {
  ...
  STAT_MIN_SCORES,STATUSES, STATUS_ACTIVE, STATUS_INACTIVE, COMPLETION_FIELDS, COMPLETED, COMPLETED_YES, COMPLETED_NO,
  OFFER_VISIBILITY, OFFER_VISIBILITY_PUBLIC, OFFER_VISIBILITY_PRIVATE,
}