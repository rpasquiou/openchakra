...
const NUTRISCORE_APLUS = `NUTRISCORE_APLUS`
const NUTRISCORE_AMINUS = `NUTRISCORE_AMINUS`
...
const NUTRISCORE_F = `NUTRISCORE_F`
const NUTRISCORE_M = `NUTRISCORE_M`
const NUTRISCORE_T = `NUTRISCORE_T`
...
const SCAN_STATUS_DNS = `SCAN_STATUS_DNS`
const SCAN_STATUS_ERROR = `SCAN_STATUS_ERROR`
const SCAN_STATUS_INPROGRESS = `SCAN_STATUS_INPROGRESS`
const SCAN_STATUS_READY = `SCAN_STATUS_READY`

const SCAN_STATUSES = {
  [SCAN_STATUS_DNS]: `DNS`,
  [SCAN_STATUS_ERROR]: `ERROR`,
  [SCAN_STATUS_INPROGRESS]: `INPROGRESS`,
...
module.exports = {
  ...
  SCAN_STATUSES,SCAN_STATUS_INPROGRESS,SCAN_STATUS_READY,
}