const GENDER_UNKOWN='UNKOWN'
const GENDER_MALE='MALE'
const GENDER_FEMALE='FEMALE'

const GENDER = {
  [GENDER_UNKOWN]: 'Non défini',
...
const TIPS=[
  "Limiter la consommation de sel (diminution du sodium) tout en privilégiant les légumes et les graines (riches en potassium) peut aider à réduire la tension artérielle (équilibre sodium potassium) (source frhta.org)",
  "En moyenne, diminuer sa consommation de sel de 1g par jour permet d'agir à la baisse sur la tension systolique (1g de sel = 5 olives, 1 tranche de saumon fumé, 1 tranche de jambon, 1 portion de fromage, 1 pain au chocolat...) (source frhta.org)",
  "Pratiquer une activité physique, marche rapide, vélo, natation, de manière régulière aide à baisser la tension systolique (à partir de 20 min tous les 3 jours) (source frhta.org)",
  "Une consommation excessive d'alcool peut dégrader l'effet des médicaments contre l'hypertension (source frhta.org)",
  "L'auto mesure de la pression artérielle à domicile permet d'éviter le phénomène d’hypertension \"blouse blanche\" (pression artérielle supérieure liée au stress de l'environnement médical) (source frhta.org)",
  "Une baisse de poids même limitée à 5 kg permet d'obtenir une baisse significative de la pression artérielle (source frhta.org)",
  "Le tabac augmente le risque de maladie cardiovasculaire chez les personnes ayant de l'hypertension (source frhta.org)",
]
