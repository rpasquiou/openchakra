...
const { getUserHomeworks, getResourceType, getAchievementRules, getBlockSpentTime, getBlockSpentTimeStr, getAllResourcesCount, getFinishedMadatoryResourcesCount, getRessourceSession, getBlockChildren} = require('./resources')
...
BLOCK_MODELS.forEach(model => {
  ...
  declareComputedField({model, field: 'finished_resources_count', getterFn: getFinishedMadatoryResourcesCount})
