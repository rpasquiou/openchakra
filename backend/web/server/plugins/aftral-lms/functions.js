...
const { getSessionCertificate, getEvalResources, getHomeworkResources } = require('./program')
...
BLOCK_MODELS.forEach(model => {
  ...
  declareVirtualField({
    model, field: 'children', instance: 'Array',
    multiple: true,
    caster: {
      instance: 'ObjectID',
      options: { ref: 'block' }
  ...
  declareComputedField({ model, field: 'finished_resources_count', getterFn: getFinishedMandatoryResourcesCount })
  declareComputedField({ model, field: 'resources_progress', requires: 'mandatory_resources_count', getterFn: getResourcesProgress })
  ...
  declareVirtualField({
    model, field: 'search_text', instance: 'String', requires: 'code,name',
  ...
  declareComputedField({ model, field: 'liked', getterFn: getBlockLiked, setterFn: setBlockLiked, requires: 'name,type' })
  declareComputedField({ model, field: 'disliked', getterFn: getBlockDisliked, setterFn: setBlockDisliked, requires: 'name,type' })
  declareVirtualField({
    model, field: 'tickets', instance: 'Array',
    caster: {
      instance: 'ObjectID',
      options: { ref: 'ticket' }
    },
  ...
  declareComputedField({ model, field: 'homework_resources', getterFn: getHomeworkResources })
...
USER_MODELS.forEach(model => {
  ...
  declareVirtualField({
    model, field: 'tickets_count', instance: 'Number',
    caster: {
      instance: 'ObjectID',
      options: { ref: 'ticket' }
    },
  ...
  declareVirtualField({
    model, field: 'sessions', instance: 'Array',
    caster: {
      instance: 'ObjectID',
      options: { ref: 'session' }
    },
...
declareVirtualField({
  model: 'progress', field: 'homeworks', instance: 'Array',
  caster: {
    instance: 'ObjectID',
...
// Post start
declareVirtualField({
  model: 'post', field: 'comments', instance: 'Array',
  multiple: true,
  caster: {
    instance: 'ObjectID',
    options: { ref: 'comment' }
...
declareVirtualField({
  model: 'post', field: 'comments_count', instance: 'Number',
  caster: {
    instance: 'ObjectID',
    options: { ref: 'block' }
  },
...
CONVERSATION_MODELS.forEach(model => {
  declareVirtualField({
    model, field: 'messages', instance: 'Array', multiple: true,
    caster: {
      instance: 'ObjectID',
      options: { ref: 'message' }
    },
  ...
  declareVirtualField({
    model, field: 'messages_count', instance: 'Number',
    caster: {
      instance: 'ObjectID',
      options: { ref: 'message' }
    },
  ...
  declareVirtualField({
    model, field: 'newest_message', instance: 'Array', multiple: false,
    caster: {
      instance: 'ObjectID',
      options: { ref: 'message' }
    },
...
declareVirtualField({ model: 'visio', field: 'future', requires: 'start_date', instance: 'Date' })
// Visio end
