...
const { ROLE_CUSTOMER, ROLE_EXTERNAL_DIET } = require('../../server/plugins/smartdiet/consts')
const User = require('../../server/models/User')

const INSERT_EVENT= (diet_id, user_id) => ({"sender":"smartagenda","senderSite":"devsmartdiet","objClass":"pdo_events","objId":"1527","action":"insert",
  "timestamp":"2023-11-10 17:20:57","data":{
    "obj":{
      "start_date":"2023-12-04 09:45:00","end_date":"2023-12-04 10:45:00","event_pid":"0",
      "presta_id":"13","equipe_id":diet_id,"ressource_id":"-1","client_id":user_id,"venu":"true","internet":"",
      "client_montant":"","couleur":"145","client_nom":"AUVRAY","client_prenom":"Sébastien","client_adresse":"",
      "client_telephone":"","client_portable":"","client_mail":"sebastien.auvray@wappizy.com","client_date_naissance":"",
      "client_infos":"","client_sexe":"F","date_modification_date":"0000-00-00 00:00:00","date_creation":"2023-11-10 17:20:57",
      "date_maj":"2023-11-10 17:20:57","client_code_postal":"","client_ville":"","montant_presta":"0.00","montant_produit":"0.00",
      "liste_attente":"N","start_date_gmt":"2023-12-04T08:45:00Z","end_date_gmt":"2023-12-04T09:45:00Z","id":"1527"
    },
  },
  "hash":"b828dcd8d84e907b7835263401a5f5ec79e6d39a7e327bdb8d2028e7dc3a2566"
})
...
describe('SmartAgenda test ', () => {
  ...
  beforeAll(async () => {
    ...
    await Appointment.remove({smartagenda_id: INSERT_EVENT().objId})
  ...
  it.only('must add appointment', async() => {
    const user=await User.findOne({role: ROLE_CUSTOMER})
      .populate({path: 'company', populate: ['current_offer', 'followup_appointment_type']})
      .populate('latest_coachings')
    const diet=await User.findOne({role: ROLE_EXTERNAL_DIET})
    await agendaHookFn(INSERT_EVENT(diet.smartagenda_id, user.smartagenda_id))
  ...
  it.skip('Must not crash on bad hook data', async() => {
