            ...
            <Layout>
                <Grid container className={classes.hideed} style={{marginTop:80,  textAlign: 'justify'}}>
                    ...
                    <Grid item xs={12}>
                        ...
                        <p>4.4 Pour ce faire, la Place de marché My-Alfred s’appuie sur le tiers de confiance MangoPay pour le paiement des Prestations de service. En utilisant ce système de paiement, les Membres acceptent les conditions de MangoPay disponibles  <a className={classes.a} target="_blank" href="/static/assets/PSP_MANGOPAY_FR-2.pdf">ici</a>. Pour toutes questions et conditions relatives au paiement des Prestations de services, les Membres devront se référer aux conditions d’utilisation du tiers de confiance MangoPay.
                    ...
                    <Grid item xs={12}>
                        ...
                        <p>9.1 My-Alfred facture des Frais de service aux Membres Utilisateurs (appelés « Frais d’Utilisateur ») et aux Membres Alfred (appelés « Frais d’Alfred »), à hauteur de 7% du panier total de la transaction chacun, en contrepartie de l’utilisation de la Place de marché My-Alfred.
                        Les Frais de service applicables (y compris les éventuelles taxes applicables) sont communiqués au Membre Alfred avant qu’il ne publie une annonce ou au Membre Utilisateur avant qu’il ne réserve un Service. My-Alfred se réserve le droit de modifier à tout moment les Frais de service et en informera les Membres dans un délai raisonnable avant l’entrée en vigueur des nouveaux tarifs. Ces modifications de frais n'auront pas d'effet sur les réservations effectuées avant leur date d’entrée en vigueur.</p>
                        <br/>Sauf stipulation contraire au sein des présentes, les Frais de service ne sont pas remboursables.
                        <br/>My-Alfred émet une facture électronique à chaque transaction. Les Membres dispensent expressément My-Alfred d’émettre les factures sur support papier.
