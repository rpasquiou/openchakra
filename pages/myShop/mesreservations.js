                    ...
                    <Grid container className={classes.bigContainer}>
                        ...
                        <Grid container>
                            <Grid item md={5} xs={12} style={{textAlign:'center', padding: '4%'}}>
                                ...
                                <Button color={"primary"} style={{borderRadius:'30px'}} variant={"contained"}><a style={{textDecoration:'none',color:'white'}} href={this.state.alfred ? '/myShop/services' : '/creaShop/creaShop'}> {this.state.alfred ? 'Ma boutique' : 'Proposer mes services'}</a></Button>
                            </Grid>
...
export default withStyles(styles)(Mesreservations);
